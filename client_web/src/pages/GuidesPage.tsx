  ...
  return (
    <section className="flex flex-col gap-stack-md pt-stack-md">
      ...
      <p className="font-body-lg text-body-lg text-on-surface-variant mb-6">
        {language === 'en' ? 'In-depth explorations to master system architecture, DevOps, and modern tools.' : 'Des explorations approfondies pour maîtriser l\'architecture système, le DevOps et les outils modernes.'}
      </p>
            ...
            <Link key={guide.id} to={`/guides/${guide.slug}`} className="block outline-none focus:ring-4 focus:ring-primary">
              ...
              <div className="flex-1">
                ...
                <h2 className="font-headline-md text-headline-md text-on-background mb-3 group-hover:underline decoration-[3px] underline-offset-4">
                  {(language === 'en' && guide.titleEn) ? guide.titleEn : guide.title}
                </h2>
                <p className="font-body-md text-body-md text-on-secondary-container mb-6 opacity-80 text-black line-clamp-3">
                  {(language === 'en' && guide.descriptionEn) ? guide.descriptionEn : guide.description}
                </p>
